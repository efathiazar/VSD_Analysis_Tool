function VSD_analysis_Oliver(varargin)
...
clear all
close all
cd 'E:\Master project\VSD analysis\Helges VSD Data Analysis\Experiment_VSD_v3.0_extracted'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% For debugging
%      dbstop if error
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
do_bool.do_load_existing_ROIS               = false;
        ...
        for i=1:size(folders.experiment_folders,1)
            ...
            if ~strcmp(folders.nam,[folders.PathName,filesep,'routines',filesep]) &&...
                ...
                if ~isempty(folders.listing)
                    ...
                    save(folders.FileName,'runtimevar','-v7.3');
                end
            end
        end
